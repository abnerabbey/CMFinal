...
- (void)renderFrameQCAR
{
    ...
    for (int i = 0; i < state.getNumTrackableResults(); ++i) {
        ...
        if (offTargetTrackingEnabled) {
            ...
            //AQUÍ VA EL CÓDIGO PARA CARGAR LA URL
            int numberTarget = trackable.getId();
            switch(numberTarget)
            {
                case 1:
                    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.youtube.com/results?search_query=jsQ5DugrfOU"]];
                    break;
                case 2:
                    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.youtube.com/results?search_query=e2wqq5agMJM"]];
                    break;
                case 3:
                    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.youtube.com/results?search_query=4iN2e9eTH7o"]];
                    break;
                case 4:
                    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.youtube.com/results?search_query=yf1UzIe6jLA"]];
                    break;
                case 5:
                    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.youtube.com/results?search_query=vpyC06tqoz4"]];
                    break;
                case 6:
                    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.youtube.com/results?search_query=jGInibv1wvQ"]];
                    break;
                case 7:
                    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.youtube.com/results?search_query=ds99On34Vd0"]];
                    break;
                case 8:
                    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.youtube.com/results?search_query=PblkS61q4vo"]];
                    break;
                case 9:
                    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.youtube.com/results?search_query=9y1O_73BMnE"]];
                    break;
                default:
                    break;
